...
namespace bidcardcoin_WPF_B2.DAL
{
    class ProduitDAL
    {
        ...
        public static ProduitDAO getProduit(int id)
        {
            ...
            MySqlDataReader reader = cmd.ExecuteReader();
            reader.Read();
            ProduitDAO cat = new ProduitDAO(reader.GetInt32(0), reader.GetFloat(1), reader.GetFloat(2), reader.GetString(3), reader.GetString(4), reader.GetString(5), reader.GetString(6), reader.GetInt32(7), reader.GetInt32(8), reader.GetInt32(9), reader.GetInt32(10));
            reader.Close();
            return cat;
        }
